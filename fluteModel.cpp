...
class mydsp : public dsp {
 ...
 public:
  ...
  void metadata(Meta* m) { 
    ...
    m->declare("filename", "fluteModel.dsp");
    m->declare("filters_lib_dcblocker_author", "Julius O. Smith III");
    m->declare("filters_lib_dcblocker_copyright", "Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>");
    m->declare("filters_lib_dcblocker_license", "MIT-style STK-4.3 license");
    ...
    m->declare("filters_lib_zero_author", "Julius O. Smith III");
    m->declare("filters_lib_zero_copyright", "Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>");
    m->declare("filters_lib_zero_license", "MIT-style STK-4.3 license");
    m->declare("library_path0", "/project/physmodels.lib");
    m->declare("library_path1", "/libraries/stdfaust.lib");
    ...
    m->declare("library_path5", "/libraries/routes.lib");
  ...
  virtual void buildUserInterface(UI* ui_interface) {
    ...
    ui_interface->addHorizontalSlider("pressure", &fHslider2, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
    ui_interface->addHorizontalSlider("tubeLength", &fHslider1, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.001f));
    ui_interface->closeBox();
  }
  ...
  virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
    ...
    float fSlow0 = 0.4f * (float(fHslider0) + -0.5f);
    float fSlow1 = float(fHslider1) + 0.27f;
    float fSlow2 = fConst2 * fSlow1 * (fSlow0 + 0.27f);
    float fSlow3 = fSlow2 + -1.499995f;
    int iSlow4 = int(fSlow3);
    int iSlow5 = int(std::min<float>(fConst1, float(std::max<int>(0, iSlow4 + 4)))) + 1;
    float fSlow6 = std::floor(fSlow3);
    float fSlow7 = fSlow2 + (-3.0f - fSlow6);
    float fSlow8 = fSlow2 + (-2.0f - fSlow6);
    float fSlow9 = fSlow2 + (-1.0f - fSlow6);
    float fSlow10 = fSlow9 * fSlow8;
    float fSlow11 = 0.041666668f * fSlow10 * fSlow7;
    int iSlow12 = int(std::min<float>(fConst1, float(std::max<int>(0, iSlow4 + 3)))) + 1;
    float fSlow13 = fSlow2 + (-4.0f - fSlow6);
    float fSlow14 = 0.16666667f * fSlow10 * (0.0f - fSlow13);
    int iSlow15 = int(std::min<float>(fConst1, float(std::max<int>(0, iSlow4 + 2)))) + 1;
    float fSlow16 = 0.5f * fSlow9 * (0.0f - fSlow7) * (0.0f - 0.5f * fSlow13);
    int iSlow17 = int(std::min<float>(fConst1, float(std::max<int>(0, iSlow4 + 1)))) + 1;
    float fSlow18 = (0.0f - fSlow8) * (0.0f - 0.5f * fSlow7) * (0.0f - 0.33333334f * fSlow13);
    float fSlow19 = fSlow2 - fSlow6;
    int iSlow20 = int(std::min<float>(fConst1, float(std::max<int>(0, iSlow4)))) + 1;
    float fSlow21 = (0.0f - fSlow9) * (0.0f - 0.5f * fSlow8) * (0.0f - 0.33333334f * fSlow7) * (0.0f - 0.25f * fSlow13);
    float fSlow22 = fConst3 * float(fHslider2);
    float fSlow23 = fConst2 * fSlow1 * (0.73f - fSlow0);
    float fSlow24 = fSlow23 + -1.499995f;
    int iSlow25 = int(fSlow24);
    int iSlow26 = int(std::min<float>(fConst1, float(std::max<int>(0, iSlow25 + 4)))) + 1;
    float fSlow27 = std::floor(fSlow24);
    float fSlow28 = fSlow23 + (-3.0f - fSlow27);
    float fSlow29 = fSlow23 + (-2.0f - fSlow27);
    float fSlow30 = fSlow23 + (-1.0f - fSlow27);
    float fSlow31 = fSlow30 * fSlow29;
    float fSlow32 = 0.041666668f * fSlow31 * fSlow28;
    int iSlow33 = int(std::min<float>(fConst1, float(std::max<int>(0, iSlow25 + 3)))) + 1;
    float fSlow34 = fSlow23 + (-4.0f - fSlow27);
    float fSlow35 = 0.16666667f * fSlow31 * (0.0f - fSlow34);
    int iSlow36 = int(std::min<float>(fConst1, float(std::max<int>(0, iSlow25 + 2)))) + 1;
    float fSlow37 = 0.5f * fSlow30 * (0.0f - fSlow28) * (0.0f - 0.5f * fSlow34);
    int iSlow38 = int(std::min<float>(fConst1, float(std::max<int>(0, iSlow25 + 1)))) + 1;
    float fSlow39 = (0.0f - fSlow29) * (0.0f - 0.5f * fSlow28) * (0.0f - 0.33333334f * fSlow34);
    float fSlow40 = fSlow23 - fSlow27;
    int iSlow41 = int(std::min<float>(fConst1, float(std::max<int>(0, iSlow25)))) + 1;
    float fSlow42 = (0.0f - fSlow30) * (0.0f - 0.5f * fSlow29) * (0.0f - 0.33333334f * fSlow28) * (0.0f - 0.25f * fSlow34);
    for (int i0 = 0; i0 < count; i0 = i0 + 1) {
      iRec15[0] = 0;
      fRec21[0] = 0.285f * fRec20[1] + 0.7f * fRec21[1];
      float fRec19 = fRec21[0] + float(iRec15[1]);
      fRec22[0] = fRec1[1];
      fRec23[IOTA0 & 511] = 0.95f * fRec22[1];
      fVec0[0] = fSlow21 * fRec23[(IOTA0 - iSlow20) & 511] + fSlow19 * (fSlow18 * fRec23[(IOTA0 - iSlow17) & 511] + fSlow16 * fRec23[(IOTA0 - iSlow15) & 511] + fSlow14 * fRec23[(IOTA0 - iSlow12) & 511] + fSlow11 * fRec23[(IOTA0 - iSlow5) & 511]);
      fRec24[0] = fSlow22 + fConst4 * fRec24[1];
      float fTemp0 = fRec24[0] - 0.5f * fVec0[1];
      ...
      fVec2[0] = fSlow42 * fVec1[(IOTA0 - iSlow41) & 1023] + fSlow40 * (fSlow39 * fVec1[(IOTA0 - iSlow38) & 1023] + fSlow37 * fVec1[(IOTA0 - iSlow36) & 1023] + fSlow35 * fVec1[(IOTA0 - iSlow33) & 1023] + fSlow32 * fVec1[(IOTA0 - iSlow26) & 1023]);
      fRec20[0] = fVec2[1];
      float fRec16 = fRec19;
      float fRec17 = fRec20[0];
      float fRec18 = fRec20[0];
      fRec11[IOTA0 & 1023] = fRec16;
      float fRec12 = fSlow42 * fRec11[(IOTA0 - iSlow41) & 1023] + fSlow40 * (fSlow39 * fRec11[(IOTA0 - iSlow38) & 1023] + fSlow37 * fRec11[(IOTA0 - iSlow36) & 1023] + fSlow35 * fRec11[(IOTA0 - iSlow33) & 1023] + fSlow32 * fRec11[(IOTA0 - iSlow26) & 1023]);
      float fRec13 = fRec17;
      float fRec14 = fRec18;
      fRec7[0] = fRec12;
      float fRec8 = fRec7[1];
      float fRec9 = fRec13;
      float fRec10 = fRec14;
      fRec3[IOTA0 & 511] = fRec8;
      float fRec4 = fSlow21 * fRec3[(IOTA0 - iSlow20) & 511] + fSlow19 * (fSlow18 * fRec3[(IOTA0 - iSlow17) & 511] + fSlow16 * fRec3[(IOTA0 - iSlow15) & 511] + fSlow14 * fRec3[(IOTA0 - iSlow12) & 511] + fSlow11 * fRec3[(IOTA0 - iSlow5) & 511]);
      float fRec5 = fRec9;
      float fRec6 = fRec10;
      fRec1[0] = fRec4;
      fRec2[0] = fRec6;
  ...
  #define FAUST_FILE_NAME "fluteModel.dsp"
  ...
  FAUST_ADDHORIZONTALSLIDER("mouthPosition", fHslider0, 0.5f, 0.0f, 1.0f, 0.01f);
  FAUST_ADDHORIZONTALSLIDER("pressure", fHslider2, 0.0f, 0.0f, 1.0f, 0.01f);
  FAUST_ADDHORIZONTALSLIDER("tubeLength", fHslider1, 1.0f, 0.0f, 2.0f, 0.001f);

  #define FAUST_LIST_ACTIVES(p) \
    p(HORIZONTALSLIDER, mouthPosition, "mouthPosition", fHslider0, 0.5f, 0.0f, 1.0f, 0.01f) \
    p(HORIZONTALSLIDER, pressure, "pressure", fHslider2, 0.0f, 0.0f, 1.0f, 0.01f) \
    p(HORIZONTALSLIDER, tubeLength, "tubeLength", fHslider1, 1.0f, 0.0f, 2.0f, 0.001f) \
...
fluteModel::fluteModel() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void fluteModel::updateImp(void)
{
#if MIDICTRL
...
void fluteModel::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void fluteModel::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float fluteModel::getParamValue(const std::string& path)
{
